...
def main():
    ...
    for i, name in enumerate(names, 1):
        ...
        for context in ["work", "home"]:
            svg_file = Path(outfolder) / f"mug_{i:02d}_{safe_name}_{context}.svg"
            generate_mug_svg(template, name, svg_file, context, veogo, False)
